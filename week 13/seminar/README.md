...
Да се напише функция, която пресмята стойността на израз, формулиран чрез цели числа, знаци за събиране, изваждане, деление, умножение и повдигане на степен и скоби. Приоритет на операциите да се взима под внимание и да следва следния ред: повдигане на степен, умножение, деление, събиране, изваждане.
...
**Вход:** 2+3*((1+4)*5)-7^2 <br>
**Изход:** 28

**Илюстрация:**<br>
2+3*((1+4)*5)-7^2 = 2+3*(5*5)-7^2 = 2+3*25-7^2 = 2+3*25-49 = 2+3*25-49 = 2+75-49 = 77 - 49 = 28
...
Даден е лабиринт с **M** реда и **N** колони, където с ***0*** са означени проходимите клетки, а с ***1 -*** блокираните. Да се изведе кой да е път от стартовата точка (**sty**, **stx**) до финалната (f**ny**, **fnx**).
